    ...
    <div className="p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Complete order history and management ({filteredOrders.length} orders)
          </p>
        </div>
        
        <Button onClick={handleExportOrders} variant="outline" className="mt-4 sm:mt-0">
      ...
      <div className="mt-8 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
        <h3 className="font-medium text-yellow-800 dark:text-yellow-200 mb-2">
          ⚠️ Order Management - UI Only
        </h3>
        <p className="text-sm text-yellow-700 dark:text-yellow-300">
          This order management interface is for demonstration purposes. To make it functional, you'll need to implement backend APIs for order updates, status changes, and tracking integration.
        </p>
      </div>
    </div>
  );
